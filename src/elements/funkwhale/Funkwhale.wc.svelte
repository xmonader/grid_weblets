<!-- // // [1] Tabs
 ...
 // // [2] content
 //     - SolutonName : text
 //     - Package  : radio (s,g,d) >> take input do nothing
 //     1cpu+ 4ram =8disk

 // // [3] deploing with dynamic capacity with prefix_gateway
 // // funkwhale_audio.balbla
 //     - call the grid3_client_ts to deploy

 // // [4] return the info
 //     - list of (solution name, machine ip, domain)
 //     - buton to shoe more -->
